            ...
            <WholePageWrapper>
                        ...
                        >
                            {imgContent === "jack" ? <div>
                                ...
                                <Flex margin="70px 0px 40px 0px" alignItems="center" justifyContent="center">
                                    <Text fontSize="24px" fontWeight={400} color="white" fontFamily="Playfair Display">{t("JackMaWords")}</Text>
                                </Flex>
                                ...
                                <Flex margin="70px 0px 40px 0px" alignItems="center" justifyContent="center" width="90%">
                                    <Text fontSize="24px" fontWeight={400} color="white" fontFamily="Playfair Display">{t("SamWaltonWords")}</Text>
                                </Flex>
                ...
                <RightSide>
                    <div style={{
                        ...
                        <Select value={lang} className={classes.select}
                            disableUnderline
                            inputProps={{
                            ...
                            <MenuItem value="ru">
                                <RuFlagIcons />
                                <Text marginLeft="10px" fontSize={FONT_SIZE.meduim} fontWeight={500}>Russian </Text> </MenuItem>
                        </Select>
                    </div>
                    <div style={{ flexGrow: 1, justifyContent: "center", alignItems: "center", display: "flex", marginTop: "5%", width: "100%" }}>
