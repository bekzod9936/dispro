...
import { CustomButton, ModalComponent, SectionWrapper } from '../../../styles/CustomStyles';
...
import { Avatar, Input, InputAdornment, InputLabel, Modal } from '@material-ui/core';
...
const AboutSection: React.FC<IProps> = ({ currentFilial, setSection }) => {
    ...
    const { control, handleSubmit, setValue, formState: { errors }, setError, clearErrors, watch } = useForm();
    const [socialLinksState, setSociaLinksState] = useState<any>([]);
    const [presentationalSocialLinks, setPresentationalSocialLinks] = useState<any>(socialLinks);
            ...
            <AboutSectionWrapper>
                {(response?.data?.data && currentFilial && options.length) &&
                    <form onSubmit={handleSubmit(onFormSubmit)} style={{ width: "100%" }}>
                        <ScrolableWrapper style={{ padding: "50px 40px", height: "1200px", boxSizing: "border-box" }} id="scrollableWrapper">
                            ...
                            <div style={{ display: "flex", height: '65vh', justifyContent: 'start', alignItems: "flex-start", overflowY: "scroll", flexDirection: "row" }}>
                                <Flex flexDirection="column" alignItems="center" width="50%" margin="0px 0px 200px 0px">
                                    {inputsArray.map((item: any) => {
                                        if (item.type === "file") {
                                            if (!logo && logoStatus === "static") {
                                            ...
                                            else if (logoStatus === "deleting" || logoStatus === "uploading") {
                                                return <div>
                                                    <Spinner />
                                                </div>
                                                ...
                                                return <div style={{ width: '85%' }}>
                                                    <div style={{ marginBottom: "10px" }}><Text fontSize="18px">{t("logo")}</Text></div>
                                                    <div style={{ position: 'relative', width: "fit-content" }}>

                                                        <div
                                                            style={{ width: "auto", height: "auto", position: "relative" }}
                                                        >
                                                            {imageLoaded === "notLoaded" && <Skeleton width="150px" height="150px" style={{ borderRadius: "14px", position: "absolute", zIndex: 200 }} />}
                                                            ...
                                                            <LazyLoadImage
                                                                ...
                                                                src={logo}
                                                                onLoadCapture={() => { setImageLoaded("loaded") }}


                                                                style={{ borderRadius: "14px", width: "150px", height: "150px", filter: hover ? "brightness(0.6)" : "brightness(1)" }}
                                                            />
                                                        </div>
                                                        <div onClick={handleDeleteLogo} style={{
                                                            position: "absolute",
                                                            top: "50%",
                                                            left: "50%",
                                            ...
                                            return (<>
                                                <Controller
                                                    ...
                                                    render={({ field, fieldState }) => {
                                                        ...
                                                        return <CustomInput flexStyle={{ width: "85%" }} style={{ width: "100%" }} field={field} fieldState={fieldState} label={item.label} aboveInput={item.aboveInput} aboveLabel={item.aboveLabel} />


                                                    }
                                                    } />
                                                {errors[item.name]?.type === "required" && <div style={{ width: "80%", alignSelf: "start" }}>
                                                    <Text marginLeft="10%" fontSize="12px" fontWeight={400} color="red">
                                                        {t("requiredField")}
                                                    </Text>
                                                </div>}
                                            ...
                                            return <Controller
                                                ...
                                                rules={{ required: true }}
                                                render={({ field, fieldState }) => {
                                                    return <CustomTextArea fieldState={fieldState} field={field} label={item.label} />
                                                }
                                                } />
                                        }
                                            ...
                                            return (
                                                <>
                                                    <Controller
                                                        ...
                                                        render={({ field, fieldState }) => {
                                                            return <CustomMulitpleSelect
                                                                //style = {{border : }}

                                                                fieldState={fieldState}
                                                                field={field} options={options} label={item.label} />
                                                        }
                                                        } />
                                                    {
                                                            ...
                                                            <div style={{ width: "85%", marginTop: "25px" }}>
                                                                ...
                                                                <Input
                                                                    ...
                                                                    style={{
                                                                        ...
                                                                        width: "100%",
                                                                        border: !keywordsError ? "1px solid #c4c4c4" : "1px solid red",
                                                                        borderRadius: "14px",
                                                                        overflow: 'hidden'
                                                                    }}
                                                                ...
                                                                {keywordsError ? <Text fontSize="13px" fontWeight={400} color="red">{t("requiredField")}</Text> : null}
                                                            </div>
                                ...
                                <Flex flexDirection="column" alignItems="flex-start" width="50%" margin="0px 0px 0px 30px">
                                    {secondColumn.map((item: any) => {
                                        if (item?.type === "text") {
                                            return (<Controller
                                                ...
                                                name={item.name}
                                                render={({ field }) => {
                                                    return <CustomInput field={field} label={item.label} aboveInput={item.aboveInput} aboveLabel={item.aboveLabel} />
                                                }
                                                } />)
                                        }
                                    })}
                                    ...
                                    <div style={{ width: "85%", justifyContent: "space-between", marginTop: "20px", display: "flex", flexDirection: "column" }}>
                                        {presentationalSocialLinks.map(({ Icon, name, value }: any) => {
                                            return (
                                                <Flex justifyContent="space-between" width="100%" alignItems="center">
                                                    ...
                                                    <div onClick={() => handleConnect(name)}><Text fontSize="16px" fontWeight={300} color="#3492FF">{value || t("connect")}</Text></div>
                                                </Flex>
                                            )
                                        })}
                        ...
                        <div className="areaforsavebutton" style={{
                            ...
                            bottom: "-0px",
                            background: "white",
                            width: document.getElementById("scrollableWrapper")?.getBoundingClientRect().width + "px    ",
                            display: 'flex',
                            justifyContent: "center"
                        }}>
                ...
                <Notification open={requestError === "successUpload" || requestError === "successDelete"} handleClose={() => { setRequestError(null) }} message={t(requestError)} />
                <Notification open={requestError === "errorUpload" || requestError === "errorDelete"} message={t(requestError)} handleClose={() => { setRequestError(null) }} />
            </AboutSectionWrapper >
                ...
                <ModalComponent>
                    ...
                    <div style={{ width: "100%", display: "flex", justifyContent: "flex-end", marginTop: "15px" }}>
                        <CustomButton onClick={handleSaveLink}>
                            <SaveIcon />
                            <Text marginLeft="10px" color="white">{t("add")}</Text>
                        </CustomButton>
                    </div>
                </ModalComponent>
