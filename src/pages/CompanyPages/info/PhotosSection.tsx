            ...
            <div style={{ width: '70%', alignSelf: 'start', marginLeft: '3%' }}>
              <div>
                <Text fontSize='16px' fontWeight={300}>
                  Можно загрузить еще {10 - images.length} фотографий JPG или
                  PNG, минимальное разрешение 540*480рх, размер не более 3Мбайт.
                </Text>
              </div>
              <div style={{ marginTop: '15px' }}>
                <Text fontSize='16px' fontWeight={300}>
                  Вы можете изменить порядок фотографий перетаскивая их: первая
                  фотография будет использована как фон для карточки вашего
                  заведения в мобильном приложении.
                </Text>
              </div>
            </div>
