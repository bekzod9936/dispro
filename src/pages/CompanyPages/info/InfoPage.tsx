...
import { CustomButton, ModalComponent, PageWrapper, PageWrapperNoScroll } from '../../../styles/CustomStyles';
import AboutSection from './AboutSection';
import AddressSection from './AddressSection';
import PhotosSection from './PhotosSection';
import { Text } from '../../../styles/CustomStyles';
import { CancelIcon } from '../../../assets/icons/ClientsPageIcons/ClientIcons';
import { QuitBlackIcon, QuitWhiteIcon } from '../../../assets/icons/InfoPageIcons/InfoPageIcons';
...
const InfoPage = () => {
    ...
    const renderSection = () => {
        switch (section) {
            case "aboutCompany":
                return <AboutSection currentFilial={infoState} setSection={setSection} />
            case "address":
    ...
    return (
        <PageWrapperNoScroll>
            <Flex margin="0px" justifyContent="space-between" width="90%">
                <Flex width="40%" alignItems="center" margin="0px" justifyContent="space-between">
                    ...
                    <Flex justifyContent="space-between" flexDirection="column" alignItems="flex-start">
                        ...
                        <div style={{ width: "310px" }}>
                            <Text fontSize="14px" fontWeight={300}>
                                При выходе все данные которые вы заполнили
