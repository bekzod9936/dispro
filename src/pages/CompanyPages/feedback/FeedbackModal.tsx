...
import {
  LighterRatingStarIcon,
  MessageIcon,
  MoneyHorizontalIcon,
  PickedRatingStarIcon,
    ...
    <CustomModal open={open}>
      <ModalComponent>
        <Flex margin='0px' width='100%' justifyContent='space-between'>
          <Flex margin='0px'>
            <Avatar
              style={{ height: '50px', width: '50px', borderRadius: '14px' }}
        ...
        <div style={{ marginTop: '20px' }}>
          <Text marginLeft='0' marginRight='0' fontSize='14px' fontWeight={500}>
            {t('review')}:
          </Text>
        </div>
            ...
            <div>
              <div>
                <Text marginLeft='12px' fontSize='14px' fontWeight={300}>
                  Операция от{' '}
                  {moment(pickedReview.createdAt).format('DD.MM.YYYY')}
                </Text>
              </div>
              <div>
                <Text marginLeft='12px' fontSize='14px' fontWeight={300}>
