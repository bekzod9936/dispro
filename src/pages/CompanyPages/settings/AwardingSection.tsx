...
const AwardingSection = () => {
    ...
    const TOTAL_FIELDS_PATTERN: ITotal[] = [
        ...
        },
        {
            amount: 0,
            isActive: false,
            levels: [{ requirements: [{ id: 0, type: "1", unit: "UZS", amount: "", condition: "" }] }],
            rewardType: 4,
            userType: 1,
        },
        {
    ...
    const handleSwitch = (checked: boolean, item: any, index: number) => {
        ...
        if (!exist && checked) {
            ...
            let searchingIndex = filtered.findIndex((value: any) => value === item.key);
        ...
        return (
            <div style={{ width: "100%" }}>
                <Controller
                    ...
                    name="awardSizeFirst"
                    render={({ field }) => {
                        return (<CustomInput field={field} style={{ width: "70%" }} label="awardSize" />)
                    }}
                />
            ...
            <div style={{ width: "100%" }}>
                ...
                <div>
                    <Controller
                        ...
                        name="awardSizeThird"
                        render={({ field }) => {
                            return (<CustomInput field={field} label="awardSize" style={{ width: "70%" }} />)
                        }}
                    />
                </div>
                <div>
                    <Controller
                        ...
                        name="awardLimit"
                        render={({ field }) => {
                            return (<CustomInput field={field} label="awardLimit" style={{ width: "70%" }} />)
                        }}
                    />
            ...
            <div style={{ display: "flex", justifyContent: "start", alignItems: "start", width: "100%" }}>
                <div style={{ width: "50%" }}>
                    ...
                    <div>
                        <Controller
                            ...
                            name="payfor"
                            render={({ field }) => {
                                return (<CustomInput field={field} label="payfor" aboveLabel="dayTillBirthday" />)
                            }}
                        />
                ...
                <div style={{ width: "50%" }}>
                    <Controller
                        ...
                        render={({ field }) => {
                            return (
                                <CustomTextArea field={field} fullWidth style={{ minHeight: '170px', background: "transparent", width: "100%", outline: "none", padding: "10px" }} label="description" />
                            )
                        }}
                    />
    ...
    const onFormSubmit = async (data: IForm) => {
        ...
        if (data.ifMoreThan) {
            TOTAL_FIELDS_PATTERN[3].levels[0].requirements[0].amount = data.ifMoreThan
        }
        if (data.payfor) {
            TOTAL_FIELDS_PATTERN[2].levels[0].beforeDay = data.payfor
        }

        console.log(TOTAL_FIELDS_PATTERN, " : TOTAL FIELD  ");
        try {
            ...
            <div style={{ display: 'flex', width: "100%", justifyContent: "space-between" }}>
                <div style={{ width: "48%" }} >
                    <Controller
                        ...
                        render={({ field }) => {
                            return (
                                <CustomInput field={field} style={{ width: "100%" }} label="awardSize" />
                            )
                        }}
                    />
                ...
                <div style={{ width: "48%" }}>
                    <Controller
                        ...
                        render={({ field }) => {
                            return (
                                <CustomInput field={field} style={{ width: "100%" }} label="ifMoreThan" />
                            )
                        }}
                    />
    ...
    const switchesFirstline = [
        {
            ...
            key: 'first',
            description: "Единоразовое начисление баллов клиенту за присоединение к компании",
        ...
        },
        {
            ...
            key: 'third',
            description: "Автоматическое начисление баллов клиенту ко дню его рождения",
    ...
    const switchesSecond = [

        {
            ...
            key: 'second',
            description: "Вознаграждение баллами клиента за друга, пришедшего по рекомендации. Начисляются   после первой операции.",
...

        {
            title: "VIP баллы",
            key: 'fourth',
            description: "Баллы, которые можно добавить постоянным   пользователям для повышения лояльности.",
    ...
    return (
        <>
            ...
            <Flex flexGrow="1" margin="0px" >
                <SettingsWrapper style={{ width: "97%", padding: "30px 10px 20px 45px", boxSizing: "border-box", }} >



                    <form onSubmit={handleSubmit(onFormSubmit)}>

                        <div style={{ display: "flex", justifyContent: "stretch", alignItems: "start", flexGrow: 1, width: switchStates.length > 0 ? "100%" : "80%" }}>
                            <Flex height="40%" width="100%" margin="0px" style={{ alignContent: "stretch" }} justifyContent="stretch" flexDirection="column" alignItems="flex-start" flexWrap="wrap">
                                {switchesFirstline.map((item: any, index: number) => {
                                    return (
                                        <Flex width="100%" margin="0px 0px 20px 0px" justifyContent="start" alignItems="flex-start" flexDirection="column" >

                                            <div style={{
                                                display: "flex", alignItems: "flex-start", justifyContent: "start", marginBottom: "15px"
                                            }}>
                                                <div>
                                                    <div>
                                                ...
                                                <div style={{ margin: "10px 0px 10px 20px" }}>
                                                    <StyledSwitch checked={switchStates.includes(item.key)} onChange={(e: any, checked: any) => handleSwitch(checked, item, index)} />
                                                </div>
                                            </div>
                            ...
                            <Flex height="40%" width={switchStates.length > 0 ? "100%" : "80%"} margin="0px" style={{ alignContent: "stretch" }} justifyContent="stretch" flexDirection="column" alignItems="flex-start" flexWrap="wrap">
