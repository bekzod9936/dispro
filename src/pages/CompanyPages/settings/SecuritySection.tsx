        ...
        return (
            <div style={{ width: "70%" }}>
                <Controller
                    ...
                    render={({ field }) => {
                        return (
                            <CustomInput field={field} label="operations_per_day" />
                        )
                    }}
                />
        ...
        return (
            <div style={{ width: "70%" }}>
                <Controller
                    ...
                    render={({ field }) => {
                        return (
                            <CustomInput field={field} label="enterSum" />
                        )
                    }}
                />
            </div>
    ...
    const switchList = [
        {
            ...
            key: "first",
            description: "Оповестим, если какой-то клиент делает слишком много покупок",
        ...
        <div style={{ display: "flex", flexGrow: 1 }}>
            <SettingsWrapper>
                <form onSubmit={handleSubmit(onFormSubmit)}>
                    <Flex margin="0px" flexDirection="column" justifyContent="start" alignItems="flex-start">

                        {switchList.map((item, index) => {
                            return <Flex width="49%" margin="20px 0px 0px 0px " justifyContent="start" alignItems="flex-start" flexDirection="column" >
                                ...
                                <div style={{
                                    ...
                                    <div style={{ margin: "10px 0px 10px 20px" }}>
                                        <StyledSwitch onChange={(e: any, checked: any) => handleSwitch(checked, item, index)} />
                                    </div>
                                </div>
