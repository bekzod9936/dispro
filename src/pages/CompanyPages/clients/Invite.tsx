    ...
    return (
        <RightSideDrawer>
            <Flex flexDirection="column" width="100%" justifyContent="space-between" alignItems="center">
                <Flex alignItems="center" width="97%" justifyContent="space-between" margin="15px 25px 0px 25px">
                ...
                <div style={{ marginTop: "25px" }}>
                    <Text marginLeft="0px" fontWeight={500} fontSize="21px" marginRight="0px">
                        {qrValue}
                    </Text>
                </div>
                <div style={{ marginTop: "80px" }}>
                    <Text marginLeft="0px" fontWeight={700} fontSize="15px" marginRight="0px" color="#c7c7c7">
                        Ссылка на присоединение
                    </Text>
                    <div style={{ marginTop: "15px", borderRadius: "12px", padding: "18px 21px", width: "100%", border: "1px solid #A5A5A5" }}>
                        <Text marginLeft="0px" fontWeight={500} fontSize="17px" marginRight="0px" color="#c7c7c7">
                            http://discount
                        </Text>
                    </div>
                </div>
