...
import { CancelIcon, CloseIcon, VioletCancelIcon, WhiteSaveIcon } from 'assets/icons/ClientsPageIcons/ClientIcons'
        ...
        <Wrapper>
            ...
            <div className="buttons">
                <Button
                    ...
                    buttonStyle={width > 600 ? { bgcolor: "#ffffff", color: "#223367" } : { bgcolor: "rgba(96, 110, 234, 0.1)", color: "#606EEA" }}
