...
import { AddInfo, BreakLine, Container, InfoBlock, InfoItem, RecommendationsBlock, Wrapper } from './style'
            ...
            <AddInfo>
                <InfoBlock>
                    ...
                    <div>
                        ...
                        <p>{t('lastPurchase')}: {moment(client?.addInfo?.lastPurchaseDate).format("DD.MM.YYYY")}</p>
                    </div>
