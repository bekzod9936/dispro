      ...
      result.push(
        <SelectedFilter>
          ...
          {!!purchaseAmount.purchaseCountTo &&
            purchaseAmount.purchaseCountTo !== "" && (
              <p>
                {!purchaseAmount.purchaseCountFrom && "Кол-во покупок: "}
                {t("to")}:{" "}
      ...
      ? [
          ...acc[day],
          {
            ...
            value: `${
              ...
              curr.cashback
                ? numberWith(curr.cashback + "", " ") + " Кешбэк "
                : ""
            }${
              curr.discount
                ? numberWith(curr.discount + "", " ") + " Скидка "
                : ""
            }${curr.point ? numberWith(curr.point + "", " ") + " Б." : ""}`,
          },
        ]
      : [
          {
