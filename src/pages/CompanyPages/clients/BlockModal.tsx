...
import { CancelIcon, WhiteLock } from '../../../assets/icons/ClientsPageIcons/ClientIcons';
            ...
            <ModalComponent>
                <form onSubmit={handleSubmit(onFormSubmit)}>
                    <Flex justifyContent="space-between">
                        <Text marginLeft="0px" marginRight="0px" fontWeight={700} fontSize="21px"> {t("blocking")}</Text>
                    </Flex>
                    <div style={{ width: "272px", marginTop: "8px" }}>
                        <Text marginLeft="0px" marginRight="0px" fontWeight={300} fontSize="14px"> {t("blockInfo")} </Text>
                    </div>

                    <div style={{ marginTop: "30px" }}>
                        <label htmlFor="reason">
                            <Text marginLeft="0px" marginRight="0px" color="#C7C7C7" fontWeight={700} fontSize="14px">{t("blockLabel")} </Text>
                        </label>
                        <Controller
                            name="blockReason"
                            control={control}
