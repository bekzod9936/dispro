      ...
      <ResetModalWrapper>
        ...
        <div className='main'>
          ...
          <span>
            ...
            {!(selectedClients.length > 1) && client.percent + '%'}
          </span>
          <RightArrowIcon />
          <p>{t('standartStatus')}</p>
          <span>
            {selectedClients.length > 1 ? 'Стандартный' : client.prevStatus}{' '}
            {!(selectedClients.length > 1) && client.prevPercent + '%'}
          </span>
        </div>
        <div className='footer'>
          ...
          <Button onClick={handleRemoveStatus} endIcon={<DoneIcon />}>
            {t('apply')}
          </Button>
        </div>
      </ResetModalWrapper>
