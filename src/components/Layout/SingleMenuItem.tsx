...
const SingleMenuItem: React.FC<ISingleMenuItem> = ({
  Icon,
  text,
  lineHeight,
  textSize,
  ...
  return (
    <SideBarMenuItem
      ...
      style={{
        position: 'relative',
        background: currentPage === text ? 'rgba(96, 110, 234, 0.1)' : 'white',
      }}
    >
      <Icon />
      <Text marginLeft='15px' fontSize={textSize} lineHeight={lineHeight}>
        {t(text)}
      </Text>
      {currentPage === text && (
        <div
